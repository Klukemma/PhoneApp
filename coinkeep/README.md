...
1. On the phone, open <https://klukemma.github.io/PhoneApp/> and pick
   **CoinKeep**.
2. Tap the **⋮** menu → **Add to Home screen** (or *Install app*).
3. Open it from your home screen. It runs full screen and works with no signal.

> Prefer to try it on a computer first? `npm start` and open
> <http://localhost:8080/coinkeep/>.
...
All paths below are relative to `coinkeep/`.
